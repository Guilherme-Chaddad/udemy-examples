package com.example.courseandroidapp.db
...
import com.example.courseandroidapp.Habit
...
private inline fun SQLiteDatabase.doQuery(table: String, columns: Array<String>, selection: String? = null, selectionArgs: Array<String>? = null,
